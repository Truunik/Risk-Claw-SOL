...
import { ThresholdCompare } from "../target/types/threshold_compare";
...
describe("ThresholdCompare", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .ThresholdCompare as Program<ThresholdCompare>;
  ...
  async function initAddTogetherCompDef(
    program: Program<ThresholdCompare>,
